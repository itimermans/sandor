...
# Change directory to the sandor directory
...
jupyter server extension disable sandor
...
folder is located. Then you can remove the symlink named `sandor` within that folder.
