...
[![Github Actions Status](https://github.com/itimermans/sandor/workflows/Build/badge.svg)](https://github.com/itimermans/sandor/actions/workflows/build.yml)

A supercharged JupyterLab environment for vehicle test data analysis

This extension is composed of a Python package named `sandor`
for the server extension and a NPM package named `sandor`
